...
import { X, Calendar, Check, HelpCircle, Hourglass } from 'lucide-react';
        ...
        <CardContent>
          {loading ? (
            ...
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm font-medium text-gray-600'>
                  {t('pages.home.overview.stats.labels.rejected.title')}
                </p>
                <div className='text-2xl font-bold text-red-600'>
                  {loading ? <Skeleton className='h-6 w-16' /> : stats?.rejected}
                </div>
                <p className='text-xs text-gray-500'>{t('pages.home.overview.stats.labels.rejected.description')}</p>
              </div>
